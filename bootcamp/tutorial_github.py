...
2)           git config --global user.email "ваi email"
...
13. В нашем GitHub копируем наш SSH адрес (это адрес у нас появился после генерации ключа)

14. Далее в терминале прописываем команду:      git remote add origin SSH адрес 
